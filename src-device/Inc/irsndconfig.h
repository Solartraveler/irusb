...
//make this equal with the settings in irmpconfig.h, otherwise strange things will happen
...
#define IRSND_SUPPORT_TECHNICS_PROTOCOL         1       // TECHNICS             >= 10000                 DON'T CHANGE, NOT SUPPORTED YET!
...
#  define IRSND_PORT_LETTER                     TIM2_CH1_Port           //Port of Transmit PWM Pin e.g.
#  define IRSND_BIT_NUMBER                      TIM2_CH1_Pin            //Pin of Transmit PWM Pin e.g.
#  define IRSND_TIMER_HANDLER                   htim2                   //Handler of Timer e.g. htim (see tim.h)
#  define IRSND_TIMER_CHANNEL_NUMBER            TIM_CHANNEL_1           //Channel of the used Timer PWM Pin e.g. TIM_CHANNEL_2
#  define IRSND_TIMER_SPEED_APBX                12000000                //Speed of the corresponding APBx. (see STM32CubeMX: Clock Configuration)
